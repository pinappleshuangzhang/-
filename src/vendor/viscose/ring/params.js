...
export function defaultParams() {
  return {
    ...
    holdAfter: 0,
    loaderChase: 0.18,
    loaderBottom: 20, // 与页面右侧、底部保持相同的 20px 边距
    loaderSize: 12,
    ...
    spinDelay: 0,
    posX: -1.48, // 最终圆心 x=-346px（相对 1440px 画布）
    posY: 0,
    endScale: 4.21, // 最终卡片宽 90 × 4.21 ≈ 379px
    moveTime: 2.2,
    ...
    brandTextTime: 1.2,
    brandBackgroundTime: 0.9,
    brandBackgroundAt: 0.5,
    brandTextAt: 0.58, // 图片左边缘越过文字右边缘后开始揭示
    ...
    nameFont: "Noto Serif SC",
    nameWeight: 500,
    idxSize: (16 / 1440) * 100, // a step lighter and smaller than the name
    idxFont: "Libre Bodoni",
    idxWeight: 400,
    listSize: (16 / 1440) * 100, // Figma 最终分类列表 16px
    ...
    bandBottom: 0.08,
    refract: 30, // px the image is pulled in at the very edge
    squeeze: 0.05,
